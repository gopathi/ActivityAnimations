 ...
 */
public class ActivityAnimationsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //basically the below line will load all the bitmaps and scaled down thumbnails in an array list
...
//            thumbnailDrawable.setColorFilter(grayscaleFilter);
            ...
            Log.d("inside addview", "onCreate: "+i);
        }
    }
    ...
    private View.OnClickListener thumbnailClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            //adds the xy-coordinates to the passedon empty integers
            v.getLocationOnScreen(screenLocation);
            PictureData info = mPicturesData.get(v);
            Intent subActivity = new Intent(ActivityAnimationsActivity.this,
